...
@section('main-content')
						...
						<div class="col-lg-8 col-12">
							<div class="form-main">
								<div class="title">
									...
									@endphp
									<h4>Liên hệ</h4>
									<h3>Viết tin nhắn cho chúng tôi @auth @else<span style="font-size:12px;" class="text-danger">[Bạn cần phải đăng nhập đầu tiên]</span>@endauth</h3>
								</div>
								<form class="form-contact form contact_form" method="post" action="{{route('contact.store')}}" id="contactForm" novalidate="novalidate">
									...
									<div class="row">
										...
										<div class="col-lg-6 col-12">
											<div class="form-group">
												<label>Đối tượng<span>*</span></label>
	...
	<div class="map-section">
		<div id="myMap">
		 ...
		 <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3826.5021346278536!2d107.66211871468951!3d16.450092788646618!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3141a1e0d62e2147%3A0x74fb34cae6903c6!2zUXXDoW4gdOG6oXAgaMOzYSBMw6ogWMOhIFTDonkgw5RuZyBLaG_hurs!5e0!3m2!1svi!2s!4v1625735629795!5m2!1svi!2s" width="100%" height="100%" frameborder="0" style="border:0;" allowfullscreen="" aria-hidden="false" tabindex="0"></iframe> 
		</div>
	</div>
	<!--/ End Map Section -->
