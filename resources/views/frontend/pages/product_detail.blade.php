...
@endsection
@section('title','HTT-shop || PRODUCT DETAIL')
								...
								<div class="row">
									...
									<div class="col-lg-6 col-12">
										<div class="product-des">
											...
											<!-- Color -->
											{{-- <div class="color">
												<h4>Tùy chọn có sẵn <span>màu</span></h4>
												<ul>
											...
											<div class="product-buy">
												...
												<p class="cat mt-1">Hãng:<a href="{{route('product-sub-cat',[$product_detail->cat_info['slug'],$product_detail->sub_cat_info['slug']])}}">{{$product_detail->sub_cat_info['title']}}</a></p>
												@endif
										...
										<div class="product-info">
											<div class="nav-main">
												...
												<ul class="nav nav-tabs" id="myTab" role="tablist">
													<li class="nav-item"><a class="nav-link active" data-toggle="tab" href="#description" role="tab">Mô tẩ</a></li>
														...
														<div class="row">
															<div class="col-12">
																...
																<div class="comment-review">
																	...
																	<h4>Xếp hạng của bạn<span class="text-danger">*</span></h4>
                                    ...
                                    <div class="product-img">
                                        ...
                                        <div class="button-head">
                                            <div class="product-action">
                                                <a data-toggle="modal" data-target="#modelExample" title="Quick View" href="#"><i class=" ti-eye"></i><span>Cửa hàng nhanh</span></a>
                                                <a title="Wishlist" href="#"><i class=" ti-heart "></i><span>Thêm vào yêu thích</span></a>
                                                <a title="Compare" href="#"><i class="ti-bar-chart-alt"></i><span>thêm vào để so sánh</span></a>
                                            </div>
                    ...
                    <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
                        <div class="quickview-content">
                            ...
                            <div class="quickview-peragraph">
                                <p>MÁY ẢNH CANON EOS 5D MARK IV BODY</p>
                            </div>
                            <!-- <div class="size">
                                <div class="row">
                                    <div class="col-lg-6 col-12">
