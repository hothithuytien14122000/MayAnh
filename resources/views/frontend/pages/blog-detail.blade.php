                ...
                <div class="col-12">
                    <div class="bread-inner">
                        <ul class="bread-list">
                            ...
                            <li class="active"><a href="javascript:void(0);">Danh sách các Blog</a></li>
                        </ul>
                    </div>
                </div>
            </div>
                    ...
                    <div class="blog-single-main">
                        <div class="row">
                            ...
                            <div class="col-12 mt-4">			
                                <div class="reply">
                                    <div class="reply-head comment-form" id="commentFormContainer">
                                        <h2 class="reply-title">Để lại bình luận bên dưới</h2>
                                        <!-- Comment Form -->
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-12">
                                                    <div class="form-group  comment_form_body">
                                                        <label>Góp ý của bạn<span>*</span></label>
                                                ...
                                                <div class="col-12">
                                                    <div class="form-group button">
                                                        <button type="submit" class="btn"><span class="comment_btn comment">Đăng </span><span class="comment_btn reply" style="display: none;">Trả lời</span></button>
                                                    </div>
                                                </div>
                                            </div>
                                        </form>
                            ...
                            <p class="text-center p-5">
                               Bạn cần phải <a href="{{route('login.form')}}" style="color:rgb(54, 54, 204)">Đăng nhập</a> Hoặc <a style="color:blue" href="{{route('register.form')}}">Đăng nhập</a> cho ý kiến.
                ...
                <div class="col-lg-4 col-12">
                    <div class="main-sidebar">
                        ...
                        <div class="single-widget category">
                            <h3 class="title">Blog danh mục</h3>
                        ...
                        <div class="single-widget newsletter">
                            ...
                            <div class="letter-inner">
                                <h4>Đăng ký để nhận <br> tin tức mới nhất</h4>
