						...
						<tbody>
							...
							@else 
								<tr>
									...
									Không có bất kỳ danh sách mong muốn nào có sẵn. <a href="{{route('product-grids')}}" style="color:blue;">tiếp tục mua sắm</a>
                                ...
                                <div class="quickview-content">
                                    ...
                                    <div class="quickview-ratting-review">
                                        ...
                                        <div class="quickview-stock">
                                            <span><i class="fa fa-check-circle-o"></i> có sẵn</span>
                                        </div>
                                    </div>
                                    <h3>$29.00</h3>
