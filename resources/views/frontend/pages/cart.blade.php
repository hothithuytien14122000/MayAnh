							...
							<div class="col-lg-8 col-md-5 col-12">
								<div class="left">
									...
									{{-- <div class="checkbox">`
										...
										@endphp
										<label class="checkbox-inline" for="2"><input name="news" id="2" type="checkbox" onchange="showMe('shipping');"> Đang vận chuyển</label>
									</div> --}}
								</div>
							</div>
							<div class="col-lg-4 col-md-7 col-12">
								<div class="right">
									<ul>
										...
										<li class="coupon_price" data-price="{{Session::get('coupon')['value']}}">Lưu<span>${{number_format(Session::get('coupon')['value'],2)}}</span></li>
										@endif
										@php
										...
										@endphp
										@if(session()->has('coupon'))
											<li class="last" id="order_total_price">Bạn phải trả<span>${{number_format($total_amount,2)}}</span></li>
										@else
											<li class="last" id="order_total_price">Bạn phải trả<span>${{number_format($total_amount,2)}}</span></li>
										@endif
									</ul>
									<div class="button5">
										<a href="{{route('checkout')}}" class="btn">Kiểm tra</a>
